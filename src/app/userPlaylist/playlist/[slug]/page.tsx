...
export default function PlaylistInfo({ params }: PageProps) {
    ...
    useEffect(() => {
        const resolveParams = async () => {
            ...
            setPlaylistId(resolvedParams.slug);
        };
        resolveParams();
    }, [params]);
    ...
    useEffect(() => {
        ...
        if (playlistData.owner && user?.accessToken) {
            fetchPlaylistOwner()
        }
    }, [user, playlistData])
        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-center">
                    ...
                    <h2 className="text-white font-bold text-2xl mb-2">Loading...</h2>
                    <p className="text-gray-400">Please wait while we load the playlist.</p>
                </div>
            </div>
        );
    }
